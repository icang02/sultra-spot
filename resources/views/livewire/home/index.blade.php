...
<main class="main" id="top">
      ...
      <div class="row align-items-center min-vh-75 my-lg-8">
        <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
          ...
          <p class="mt-4 mb-5 fs-1 lh-base">Plan and book your perfect trip with expert advice, <br
              ...
              class="d-none d-lg-block" />inspiration from us.</p><a class="btn btn-lg btn-primary hover-top"
            href="{{ route('register') }}" role="button">Sign Up Now</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row flex-md-center">
        <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
          ...
          <p class="lh-lg">Etiam facilisis, sapien quis porta dignissim, orci nisi pharetra dui, varius vehicula
            ...
            ultrices nec. Cras nulla mauris, fermentum nec libero in.</p><a class="btn btn-lg btn-primary hover-top"
            href="{{ route('login') }}" role="button">Explore</a>
        </div>
                ...
                <div class="row h-100">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top"><img class="img-fluid h-100"
                        src="{{ asset('rhea') }}/img/gallery/maldives.png" alt="" />
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top"><img class="img-fluid h-100"
                        src="{{ asset('rhea') }}/img/gallery/indonesia.png" alt="" />
                      <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                        <div class="pt-3"><span class="badge bg-primary">$860</span></div>
                        <div class="ps-3 d-flex justify-content-between align-items-center">
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top"><img class="img-fluid h-100"
                        src="{{ asset('rhea') }}/img/gallery/kathmandu.png" alt="" />
                      <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                    ...
                    <div class="col-12 px-1">
                      <button class="active" type="button" data-bs-target="#carouselExampleIndicators"
                        data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"><img class="d-block"
                          src="{{ asset('rhea') }}/img/gallery/maldives-v.png" alt="..." /></button>
                    </div>
                    <div class="col-12 px-1">
                      <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                        aria-label="Slide 2"><img class="d-block" src="{{ asset('rhea') }}/img/gallery/tanzania.png"
                          alt="..." /></button>
                    </div>
                    <div class="col-12 px-1">
                      <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"
                        aria-label="Slide 3"><img class="d-block"
                          src="{{ asset('rhea') }}/img/gallery/kathmandu-v.png" alt="..." /></button>
                    </div>
                    <div class="col-12 px-1">
                      <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3"
                        aria-label="Slide 4"><img class="d-block" src="{{ asset('rhea') }}/img/gallery/chaina.png"
                          alt="..." /></button>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row h-100">
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/food.png" alt="" /></a>
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/backpacking.png"
                            alt="" /></a>
                        <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/beaches.png"
                            alt="" /></a>
                        <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/art-culture.png"
                            alt="" /></a>
                        <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/wild.png" alt="" /></a>
                        <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img
                            class="img-fluid" src="{{ asset('rhea') }}/img/gallery/hill.jpg" alt="" /></a>
                        <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="card-body d-flex flex-center flex-column">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center"><img class="img-fluid"
                            src="{{ asset('rhea') }}/img/gallery/user-2.png" alt="" /></div>
                      </div>
                ...
                <div class="col-12 col-lg-7 mb-3 mb-md-0">
                  <div class="card h-100">
                    <div class="card-body d-flex flex-center flex-column">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center"><img class="img-fluid"
                            src="{{ asset('rhea') }}/img/gallery/user-1.png" alt="" /></div>
                      </div>
                      <div class="mt-3 text-center">
  ...
  <section id="booking">
    <div class="bg-holder"
      style="background-image:url({{ asset('rhea') }}/img/gallery/booking.png);background-position:center;background-size:cover;">
    </div>
    <!--/.bg-holder-->
