        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <p class="mb-4">
                Confused looking for tourist spots or events in Sultra? Please check the travel or event feature.
              </p>
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> All users</small>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <span>Tours</span>
              <h3 class="card-title text-nowrap mb-1">{{ App\Models\TourPlace::all()->count() }}</h3>
              <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> All tours</small>
            </div>
          </div>
        </div>
      </div>
