...
<body>
  ...
  <div class="container-xxl container-p-y">
    <div class="misc-wrapper">
      <h2 class="mb-2 mx-2">Order successfully made!</h2>
      <p class="mb-4 mx-2">Thank you for using our app — please complete your payment</p>
      <a href="{{ route('orderList') }}" class="btn btn-primary">Go to order page</a>
      <div class="mt-4">
